...
void setup() {
	...
	function_map["double_that"] = double_that_gen;function_map["tenth_that"] = tenth_that_gen;function_map["alternate_that"] = alternate_that_gen;function_map["just_do"] = just_do_gen;
}
